...
MODEL_PATH = BASE_DIR / "models" / "best_v2.pt"
SAMPLED_FRAMES_DIR = BASE_DIR / "sampled_v3_frames"
OUTPUT_LABELS_DIR = BASE_DIR / "pre_labels_v3"          # 存放预测的YOLO格式txt标注
OUTPUT_PREVIEW_DIR = BASE_DIR / "pre_labels_preview_v3" # 存放画好框的预览图，方便肉眼快速检查

CATEGORIES = ["mouse", "together"]
